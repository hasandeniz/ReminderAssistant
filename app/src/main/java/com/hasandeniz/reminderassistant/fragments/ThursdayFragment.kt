...
import kotlinx.android.synthetic.main.fragment_thursday.view.*
import kotlinx.coroutines.InternalCoroutinesApi


class ThursdayFragment : Fragment(),RecyclerViewAdapter.ItemListener, RecyclerViewAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.recyclerViewThursday
        recyclerView.adapter = adapter
        recyclerView.layoutManager = LinearLayoutManager(requireContext())
        adapter.setListener(this)
        adapter.setEditItemClickListener(this)
        mItemViewModel = ViewModelProvider(this).get(ItemViewModel::class.java)
        mItemViewModel.readThursdayData.observe(viewLifecycleOwner, Observer { item ->
